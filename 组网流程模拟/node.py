...
class Node_3D:
    def __init__(self, node_id, broadcast_range, broadcast_interval, x, y, z):
        self.node_id = node_id
        self.broadcast_range = broadcast_range
        self.broadcast_interval = broadcast_interval
    ...
    def calculate_distance(self, neighbor):
        ...
        neighbor_coordinates = neighbor.coordinates
        distance = ((neighbor_coordinates[0] - self.coordinates[0]) ** 2 +
                    (neighbor_coordinates[1] - self.coordinates[1]) ** 2 +
                    (neighbor_coordinates[2] - self.coordinates[2]) ** 2) ** 0.5
        return distance
